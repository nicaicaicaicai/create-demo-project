...
if (projectName) {
    ...
    // 2、拷贝模板文件
    fileUtil_1.copyDir('./src', projectName + "/");
    var copyFiles = ['.babelrc', '.gitignore', '.prettierrc', 'index.hbs', 'tsconfig.json', 'webpack.config.js'];
    copyFiles.forEach(function (file) {
        fileUtil_1.copyFile("./" + file, projectName + "/" + file);
    });
